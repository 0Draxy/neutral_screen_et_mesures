...
src=Path(r"C:\dev_EA_MT5\MT5_AutoLab_v0.16_LOCAL\autolab_engine_v016.py")
dst=Path(r"C:\dev_EA_MT5\MT5_AutoLab_v0.17_LOCAL\autolab_engine_v017.py")
s=src.read_text(encoding="utf-8-sig")
s=s.replace("v0.16","v0.17").replace("V016","V017").replace("v016","v017")
dst.write_text(s,encoding="utf-8")
'@
& py.exe -3 -c $pycode
if($LASTEXITCODE -ne 0 -or -not (Test-Path $engine17)){throw "Generation moteur v0.17 echouee"}
